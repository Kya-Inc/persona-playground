...
from re import I
from data.homer_simpson.character_data import character_data
...
memory = ConversationBufferMemory(
    chat_memory=msgs, ai_prefix=character_first_name, human_prefix=st.session_state.user_name_p, input_key="human_input", return_messages=True
)
